package com.my.training.Selenium.pages;
...
public class AmazonPage {
	...
	WebDriver driver;
	static Logger logger = LogManager.getLogger(AmazonPage.class);
	...
	@FindBy(xpath = "//*[contains(text(),'Get It by Tomorrow')]//ancestor::a//input//following::i")
